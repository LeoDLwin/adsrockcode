                  ...
                  <div class="table-responsive--lg">
                    <table class="table style--two custom-data-table">
                          ...
                          <tr>
                             ...
                             <td data-label="@lang('Site Keywords')"><button type="button" class="btn btn--primary btn-sm view" data-keyword="{{$keywords}}" data-toggle="modal" data-target="#modal">@lang('View')</button></td>
